...
1. Việc sao chép thủ công 4–10 link tham gia riêng lẻ rất tẻ nhạt và dễ xảy ra lỗi với các giảng viên quản lý lớp học lớn, vì vậy tôi đã thêm nút "Sao chép tất cả" để người dùng có thể sao chép tất cả link tham gia vào clipboard chỉ bằng một cú nhấp. Giảng viên giờ có thể dán trực tiếp vào email, ứng dụng nhắn tin, hoặc slide bài giảng.
